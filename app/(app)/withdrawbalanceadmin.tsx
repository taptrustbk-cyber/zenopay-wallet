    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.header}>
        ...
        <View style={{ flex: 1, alignItems: 'center' }}>
          ...
          <Text style={styles.headerSub}>Decrease user wallet balance</Text>
        </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.topBanner}>
          <View style={styles.topBannerIcon}>
            <MinusCircle size={20} color={UI.red} />
          </View>
          <View style={{ flex: 1 }}>
            <Text style={styles.sectionTitle}>Withdraw Balance From User</Text>
            <Text style={styles.sectionSub}>Choose a user and remove amount from wallet</Text>
          </View>
        </View>
          ...
          <View style={styles.modalContent}>
            <View style={styles.modalTop}>
              <View>
                ...
                <Text style={styles.modalSubtitle}>Enter amount to remove</Text>
              </View>
