...
function getTypeLabel(notes?: string | null) {
  const n = String(notes || '').toLowerCase().trim();

  if (n === 'sim') return 'SIM';
  if (n === 'gift') return 'GIFT';
  if (n === 'topup') return 'TOPUP';
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroTitle}>Manage top-up card orders</Text>
          <Text style={styles.heroText}>
            Review customer requests, update status, add PIN codes, and send notes to users.
          </Text>
        </View>
        ...
        <View style={styles.topCard}>
          ...
          <TextInput
            style={styles.input}
            placeholder="Search by name, email, city, provider, pin..."
            value={search}
        ...
        {loading ? (
          ...
          <View style={styles.emptyCard}>
            <Ionicons name="file-tray-outline" size={38} color="#B08A00" />
          ...
          filteredOrders.map((order) => {
            ...
            const typeLabel = getTypeLabel(order.notes);
            ...
            return (
              <View key={order.id} style={styles.orderCard}>
                ...
                <Text style={styles.inputLabel}>Notes / Recharge Instructions</Text>
                <TextInput
